...
int main() {
    ...
    // Django AST
    {
        ...
        if (n > 0) {
            datasets.push_back({"Django AST", "real_ast_benchmark.txt", n});
        }
    }
    ...
    // sqlite3 AST
    {
        ...
        if (n > 0) {
            datasets.push_back({"sqlite3 AST", "sqlite3_ast_edges.txt", n});
        }
    }
    ...
    // XMark XML
    {
        ...
        if (n > 0) {
            datasets.push_back({"XMark XML", "xmark_edges.txt", n});
        }
    }
